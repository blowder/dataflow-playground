...
public class WordCount {
    ...
    public static class FormatAsTextFn2 extends DoFn<KV<Long, Iterable<KV<Long, String>>>, String> {
        @ProcessElement
        public void processElement(@Element KV<Long, Iterable<KV<Long, String>>> element, OutputReceiver<String> receiver) {
            for (KV<Long, String> longStringKV : element.getValue()) {
                receiver.output(longStringKV.getKey() + ":" + longStringKV.getValue());
            }
        }
    }
    ...
    static void runWordCount(WordCountOptions options) {
        ...
        p.apply("ReadLines", TextIO.read().from(options.getInputFile()))
                ...
                .apply(Filter.by(input -> input.getValue() > 100))
